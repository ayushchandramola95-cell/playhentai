    ...
    <div className={styles.hubContainer} ref={catalogRef}>
      ...
      >
        ...
        <div className={styles.searchBox}>
          ...
          <input
            type="text"
            placeholder="Search uncensored catalog..."
            value={searchQuery}
        ...
        <div className={styles.sortGroup}>
          ...
          <div className={styles.sortDropdownWrapper}>
            ...
            <select 
              ...
              aria-label="Sort uncensored catalog"
            >
...
export default function UncensoredHub(props: UncensoredHubProps) {
  return (
    <React.Suspense fallback={<div style={{ padding: '2rem', textAlign: 'center', color: '#888' }}>Loading Uncensored Catalog...</div>}>
      <UncensoredHubContent {...props} />
    </React.Suspense>
  );
}
